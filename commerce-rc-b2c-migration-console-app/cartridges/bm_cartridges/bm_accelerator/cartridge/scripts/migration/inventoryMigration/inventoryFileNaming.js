...
/**
 * Build batch file name from user-provided base (strips/replaces -vNNN suffix per batch).
...
function resolveFileName(exportKey, offset, batchSize, customFileName) {
    ...
    return batchFileName('inventory-' + exportKeySafe(exportKey) + '-' + runDate + '-v001.xml', batchIndex);
}
