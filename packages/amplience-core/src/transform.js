...
module.exports = {
    ...
    WIDGET_TYPE_FILTERS: WIDGET_TYPE_FILTERS,
    extractPreviewParts: extractPreviewParts,
    extractPreviewPartsForLocale: extractPreviewPartsForLocale,
    detectWidgetType: detectWidgetType,
    mapToWidget: mapToWidget,
    transformFetchedContent: transformFetchedContent,
    toRendererModel: toRendererModel,
    isMeaningfulMarkup: isMeaningfulMarkup,
